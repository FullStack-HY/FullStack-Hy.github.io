...
**Note** when yo change file <i>index.js</i> React does not refresh the page automatically so you need to relead the browser page to get the new content shown.
